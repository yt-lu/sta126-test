...
ui <- fluidPage(
  ...
  sidebarLayout(
    ...
    sidebarPanel(
      ...
      # Download
      downloadButton(outputId = "downloadnum", label = "Download Question 1 Data", class = NULL, width = '155px'),
      
      # Download
      downloadButton(outputId = "downloadcat", label = "Download Question 2 Data", class = NULL, width = '155px'),
